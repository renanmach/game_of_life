...
int main(void) {
    ...
    int breaker = 0;
    int paused = 1;
    SDL_Surface* screen = SDL_SetVideoMode(scr_width, scr_height, 0, SDL_SWSURFACE);
    ...
    SDL_Surface* bcell = SDL_CreateRGBSurface(SDL_SWSURFACE, cell_width, cell_height, BLACK);
